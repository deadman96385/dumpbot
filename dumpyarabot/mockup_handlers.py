...
def _create_compact_controls_keyboard(request_id: str) -> "InlineKeyboardMarkup":
    ...
    keyboard = [
        [
            ...
            InlineKeyboardButton(
                "⬅️ Back", callback_data=f"{CALLBACK_MOCKUP_BACK}{request_id}"
            ),
            InlineKeyboardButton(
                "🗑️ Delete", callback_data=f"{CALLBACK_MOCKUP_DELETE}{request_id}"
            ),
        ]
    ]
