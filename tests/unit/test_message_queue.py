...
class TestMessageQueue:
    ...
    @pytest.mark.asyncio
    async def test_send_immediate_message(self, message_queue_instance, mock_redis, mock_bot):
    ...
    @pytest.mark.asyncio
    async def test_publish_and_return_placeholder(self, message_queue_instance, mock_redis, mock_bot):
    ...
    @pytest.mark.asyncio
    async def test_queue_dump_job_with_metadata(self, message_queue_instance, mock_redis, mock_bot):
        ...
        with patch('dumpyarabot.arq_config.arq_pool', mock_pool), \
             patch('dumpyarabot.arq_config.get_job_result_ttl', return_value=86400):
    ...
    async def test_get_job_status(self, message_queue_instance, mock_redis, mock_bot):
        ...
        with patch('dumpyarabot.arq_config.arq_pool', mock_pool), \
             patch('dumpyarabot.message_queue.DumpJob.model_validate', return_value=mock_dump_job):
    ...
    @pytest.mark.asyncio
    async def test_get_active_jobs_with_metadata(self, message_queue_instance, mock_redis, mock_bot):
    ...
    @pytest.mark.asyncio
    async def test_send_status_update(self, message_queue_instance, mock_redis, mock_bot):
    ...
    @pytest.mark.asyncio
    async def test_send_notification(self, message_queue_instance, mock_redis, mock_bot):
    ...
    @pytest.mark.asyncio
    async def test_send_cross_chat_edit(self, message_queue_instance, mock_redis, mock_bot):
...
class TestMessageQueueIntegration:
    ...
    @pytest.mark.asyncio
    async def test_error_handling_redis_failure(self, message_queue_instance, mock_redis):
    ...
    @pytest.mark.asyncio
    async def test_get_recent_jobs_with_metadata(self, message_queue_instance, mock_redis, mock_bot):
    ...
    @pytest.mark.asyncio
    async def test_send_immediate_status_update(self, message_queue_instance, mock_redis, mock_bot):
        """Test send_immediate_status_update method."""
        result = await message_queue_instance.send_immediate_status_update(
            chat_id=123456,
            text="Immediate status update",
            context={"test": "context"}
        )
    ...
    async def test_get_queue_stats(self, message_queue_instance, mock_redis, mock_bot):
        ...
        mock_redis.llen.side_effect = [5, 3, 2, 1, 0]  # urgent, high, normal, low, dead_letter
    ...
    @pytest.mark.asyncio
    async def test_get_job_queue_stats(self, message_queue_instance, mock_redis, mock_bot):
        """Test get_job_queue_stats method."""
        mock_arq_stats = {
            "queue_length": 10,
            "active_health_checks": 2
        }
    ...
    @pytest.mark.asyncio
    async def test_consumer_lifecycle(self, message_queue_instance, mock_redis, mock_bot):
